...
keep_col = ["RECTYPE", "URN", "SCHNAME", "PCODE", "PCODE2", "TOWN", "READPROG", "READPROG_DESCR", "WRITPROG",
            "WRITPROG_DESCR", "MATPROG", "MATPROG_DESCR", "OFSTEDRATING", "INSPECTIONDT", "WEB", "SCHTYPE"]
new_f = f[keep_col]
...
keep_col = ["RECTYPE", "URN", "SCHNAME", "PCODE", "PCODE2", "TOWN", "P8MEA", "P8_BANDING", "ATT8SCR",
            "PTL2BASICS_95", "PTEBACC_E_PTQ_EE", "EBACCAPS", "OFSTEDRATING", "INSPECTIONDT", "WEB", "SCHTYPE", "GRAMMAR"]
new_f = f[keep_col]
...
keep_col = ["RECTYPE", "URN", "SCHNAME", "PCODE", "PCODE2", "TOWN", "VA_INS_ALEV", "PROGRESS_BAND_ALEV",
            "TALLPPE_ALEV_1618", "TALLPPEGRD_ALEV_1618", "OFSTEDRATING", "INSPECTIONDT",
            "WEB", "SCHTYPE", "GRAMMAR"]
new_f = f[keep_col]
new_f.to_csv("england_ks5final_new.csv", index=False)

os.rename("england_ks2final.csv", "england_ks2final.csv_orig")
os.rename("england_ks4final.csv", "england_ks4final.csv_orig")
os.rename("england_ks5final.csv", "england_ks5final.csv_orig")
